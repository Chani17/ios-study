...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    // MARK: - Method
    // MARK: Custom Method
    func initializePlayer() {       // player를 초기화하는 메소드
    ...
    func updateTimeLabelText(time: TimeInterval) {      // 매 초마다 시간 텍스트 업데이트 해주는 메소드
    ...
    func makeAndFireTimer() {           // 타이머를 만들고 실행해주는 메소드
    ...
    func invalidateTimer() {            // 타미어를 해제해줄 메소드
